...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Obtnemos los datos del usuario conectado
    ...
    private void clickarEnUsuarioInfo() {
        ...
        if (settings.contains(Constantes.INICIADO) && settings.getBoolean(Constantes.INICIADO, false))
            cerrarSession();
        else {
    ...
    private void cargarDatos() {
        ...
        if (preferencias.contains(Constantes.INICIADO) && preferencias.getBoolean(Constantes.INICIADO, false)) {
            try {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    new MainActivity.MainLoginJsonTask()
                            .execute(new URL(Constantes.RUTA_USUARIO_DATOS +
                                    preferencias.getString("usuariologin", "")));
                    mostrarNavegacion();
                } else {
                    Toast.makeText(MainActivity.this, Constantes.ERROR_CONEXION, Toast.LENGTH_LONG).show();
                }
